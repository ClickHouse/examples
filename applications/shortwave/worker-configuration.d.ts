/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 5e7db79e6f39abdbf8ece792ac5b441e)
// Runtime types generated with workerd@1.20260911.1 2026-09-06 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	HYPERDRIVE: Hyperdrive;
	APP_URL: string;
	PUBLIC_CUSTOM_DOMAINS: string;
	CLERK_SECRET_KEY: string;
	CLICKHOUSE_URL: string;
	CLICKHOUSE_USERNAME: string;
	CLICKHOUSE_PASSWORD: string;
	CLICKHOUSE_DATABASE: string;
	CLICKHOUSE_CDC_DATABASE: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "PUBLIC_CUSTOM_DOMAINS" | "CLERK_SECRET_KEY" | "CLICKHOUSE_URL" | "CLICKHOUSE_USERNAME" | "CLICKHOUSE_PASSWORD" | "CLICKHOUSE_DATABASE" | "CLICKHOUSE_CDC_DATABASE">> {}
}

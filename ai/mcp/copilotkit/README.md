...
If you'd rather use another LLM provider than Anthropic, you can modify the [Copilotkit runtime](./app/api/copilotkit/route.ts) to use a different LLM adapter. [Here](https://docs.copilotkit.ai/reference/classes/llm-adapters/OpenAIAdapter) is a list of supported providers.

# Microsoft Agent Framework and ClickHouse MCP
...
Open [microsoft-agent-framework.ipynb](microsoft-agent-framework.ipynb) and run the cells in order. Use `MCP_PROMPT="Use mcp_demo.sales to calculate revenue by region."` for the shared local/Cloud fixture. Expected totals are North 250 and South 500.

## Versions and checks

Selected direct dependencies: agent-framework==1.17.0. MCP server: **0.6.0**, Python: **3.13**.

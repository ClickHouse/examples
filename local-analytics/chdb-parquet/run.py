#!/usr/bin/env python3
"""Read a Parquet file in Python with chDB, a drop-in replacement for pandas.

Companion to:
https://clickhouse.com/resources/engineering/read-parquet-file-python
...
print("=== 1. Read a Parquet file into a DataFrame (schema from metadata) ===")

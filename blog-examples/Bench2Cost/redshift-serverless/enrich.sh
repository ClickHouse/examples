#!/usr/bin/env bash
# Redshift Serverless enrich script (serverless, hardened)
# Usage:
          ...
          | map(
              ...
              | map(
                  ...
                  | {
                      ...
                      compute_costs: map2d($r.billed_times; ($t.price_usd / $t.price_unit_seconds)),
                      pricing_base: {

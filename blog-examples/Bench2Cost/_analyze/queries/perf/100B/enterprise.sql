...
--     -- 06: Databricks SQL Serverless (Large)
    SELECT '06' AS id, 'Databricks Ent (Large)' AS bar_label, 'Databricks%' AS system_pat,
    ...
    SELECT '07' AS id, 'Databricks Ent (4X-Large)' AS bar_label, 'Databricks%' AS system_pat,

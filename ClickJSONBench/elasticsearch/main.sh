...
./create_and_load.sh bluesky-source-10m-best-compression index_template_source_best_compression "$DATA_DIRECTORY" 1 "$SUCCESS_LOG" "$ERROR_LOG"
...
./create_and_load.sh bluesky-source-100m-best-compression index_template_source_best_compression "$DATA_DIRECTORY" 1 "$SUCCESS_LOG" "$ERROR_LOG"
...
# ./create_and_load.sh bluesky-source-1000m-best-compression index_template_source_best_compression "$DATA_DIRECTORY" 1 "$SUCCESS_LOG" "$ERROR_LOG"
...
./create_and_load.sh bluesky-source-10m-default-compression index_template_source_default_compression "$DATA_DIRECTORY" 1 "$SUCCESS_LOG" "$ERROR_LOG"
...
./create_and_load.sh bluesky-source-100m-default-compression index_template_source_default_compression "$DATA_DIRECTORY" 1 "$SUCCESS_LOG" "$ERROR_LOG"
...
# ./create_and_load.sh bluesky-source-1000m-default-compression index_template_source_default_compression "$DATA_DIRECTORY" 1 "$SUCCESS_LOG" "$ERROR_LOG"
...
./create_and_load.sh bluesky-no-source-10m-default-compression index_template_no_source_default_compression "$DATA_DIRECTORY" 1 "$SUCCESS_LOG" "$ERROR_LOG"
...
./create_and_load.sh bluesky-no-source-100m-default-compression index_template_no_source_default_compression "$DATA_DIRECTORY" 1 "$SUCCESS_LOG" "$ERROR_LOG"
...
# ./create_and_load.sh bluesky-no-source-1000m-default-compression index_template_no_source_default_compression "$DATA_DIRECTORY" 1 "$SUCCESS_LOG" "$ERROR_LOG"
...
./create_and_load.sh bluesky-source-10m-best-compression index_template_no_source_best_compression "$DATA_DIRECTORY" 1 "$SUCCESS_LOG" "$ERROR_LOG"
...
./create_and_load.sh bluesky-no-source-100m-best-compression index_template_no_source_best_compression "$DATA_DIRECTORY" 1 "$SUCCESS_LOG" "$ERROR_LOG"
...
# #./create_and_load.sh bluesky-no-source-1000m-best-compression index_template_no_source_best_compression "$DATA_DIRECTORY" 1 "$SUCCESS_LOG" "$ERROR_LOG"

...
./benchmark.sh bluesky_1m_snappy "${OUTPUT_PREFIX}_bluesky_1m_snappy.result"
...
./benchmark.sh bluesky_10m_snappy "${OUTPUT_PREFIX}_bluesky_10m_snappy.result"
...
./benchmark.sh bluesky_100m_snappy "${OUTPUT_PREFIX}_bluesky_100m_snappy.result"
...
./benchmark.sh bluesky_1000m_snappy "${OUTPUT_PREFIX}_bluesky_1000m_snappy.result"
